...
display = tk.Entry(window, textvariable=expression, font=('Arial', 25), justify="
right", validate="key", validatecommand=(window.register(validate_input), '%S
'))
...
scbutton = ["sin", "cos", "tan", "sec", "csc", "cot", "x^3", "e^x", "log", "ln", "π",
"!", "(", ")", "e", "10^x"]
...
text=button, font=('Arial', 16), width=5, height=0, re lief='ridge', bg="white",
borderwidth=0, highlightthickness=0, command=comm and)
